    ...
    <div class="logmod__container">
      ...
      <div class="logmod__tab lgm-1">
        ...
        <div class="logmod__form">
          <form accept-charset="utf-8"  method="post" action="register.php" class="simform">
          	<div class="sminputs">
              <div class="input full">
                <label class="string optional" for="user-name">First Name</label>
                <input class="string optional" maxlength="255" id="firstname" name="firstname" placeholder="First Name" type="text" size="50" />
              </div>
            </div>
            <div class="sminputs">
              <div class="input full">
                <label class="string optional" for="user-surname">Surname</label>
                <input class="string optional" maxlength="255" id="surname" name="surname" placeholder="Surname" type="text" size="50" />
              </div>
            </div>
            <div class="sminputs">
              <div class="input full">
      ...
      <div class="logmod__tab lgm-2">
        ...
        <div class="logmod__form">
          <form accept-charset="utf-8" action="#" class="simform">
            ...
            <div class="simform__actions">
              <button class="sumbit" type="submit" >Sign In</button>
